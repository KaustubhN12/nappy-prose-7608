import {Box,Text,SimpleGrid,Image,Container,Button ,useToast,Flex,VStack,Heading} from '@chakra-ui/react';
...
import { Spinner } from '@chakra-ui/react'
 ...
 const Loading=()=>{
    ...
    const getData=()=>{
        setIsLoading(true)
          axios.get(`https://api-nykaa-database.vercel.app/hair?_page=${page}&_limit=9`)
          .then((res)=>{
              setDatas(res.data);
...
const addToBag=()=>{
  ...
  return ( isLoading ? ( <Loading/>) : ( 
      ...
      <Box w='24%'> 
      <Box>
        <Box className='a-sidebar' h='maxContent' >
            <Box className="alldropdown">
                   <details className="sidebar-dropdown" >
                        ...
                        <details className="sidebar-dropdown">
                            ...
                            <ul>
                                <li><Box className='sidebar-checkbox'  onClick={()=>handleFilterMac("dove")} ><label>Dove</label><input id='pink' name="brand" type='checkbox' value='mac'/></Box></li>
                                <li><Box className='sidebar-checkbox'  onClick={()=>handleFilterMac("tresemme")} ><label>Tresemme</label><input  id='pink' name="brand" className='input-checkbox' type='checkbox' value='lakme' /></Box></li>
                                <li><Box className='sidebar-checkbox'  onClick={()=>handleFilterMac("biotique")} ><label>Biotique</label><input  id='pink' name="brand" className='input-checkbox' type='checkbox' value='lba' /></Box></li>
                                <li><Box className='sidebar-checkbox'  onClick={()=>handleFilterMac("nyle")} > <label>Nyle</label><input id='pink' name="brand" className='input-checkbox' type='checkbox' value='milani'/></Box></li>
                            </ul>
                        </details>
                        <hr />
                        <details className="sidebar-dropdown">
                        ...
                        <ul>
                                <li><Box className='sidebar-checkbox'  onClick={()=>handleFilterColor("white")}  ><label>White</label><input id='pink' name="color" type='checkbox' /></Box></li>
                                <li><Box className='sidebar-checkbox'  onClick={()=>handleFilterColor("red")} ><label>Red</label><input  id='pink' name="color" className='input-checkbox' type='checkbox' /></Box></li>
                                <li><Box className='sidebar-checkbox' onClick={()=>handleFilterColor("gold")} ><label>Gold</label><input  id='pink' name="color" className='input-checkbox' type='checkbox' /></Box></li>
                                <li><Box className='sidebar-checkbox' onClick={()=>handleFilterColor("blue")} > <label>Blue</label><input id='pink' name="color" className='input-checkbox' type='checkbox' /></Box></li>
                            </ul>
                    </details>  <hr />
                    <details className="sidebar-dropdown">
                    ...
                    <details className="sidebar-dropdown">
                        <summary><Box className='sidebar-title'><Text fontSize='lg' fontWeight='500'>Avg Customer Rating </Text> <GrDown/></Box> </summary>
                            <ul>
                              <li><Box className='sidebar-checkbox'  onClick={()=> handleFilterStar("5")}  ><label>5 Star </label><input id='pink' name="star" type='checkbox' /></Box></li>
