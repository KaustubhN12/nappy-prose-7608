import {Box,Text,SimpleGrid,Image,Container,Button ,useToast,Flex,VStack,Heading, Spinner} from '@chakra-ui/react';
...
import { Link, useLocation } from 'react-router-dom';
 ...
 const Loading=()=>{
    ...
    const getData=()=>{
        setIsLoading(true)
          axios.get(`https://api-nykaa-database.vercel.app/skin?_page=${page}&_limit=15`)
          .then((res)=>{
              setDatas(res.data);
                   ...
                   <details className="sidebar-dropdown" >
                        ...
                        <details className="sidebar-dropdown">
                            <summary><Box className='sidebar-title'><Text fontSize='lg' fontWeight='500'>Brand</Text> <GrDown/></Box> </summary>
                              <ul>
                                <li><Box className='sidebar-checkbox'  onClick={()=>handleFilterMac("Lakme")} ><label>Lakme</label><input id='pink' name="brand" type='checkbox' value='mac'/></Box></li>
                                <li><Box className='sidebar-checkbox'  onClick={()=>handleFilterMac("olay")} ><label>Olay</label><input  id='pink' name="brand" className='input-checkbox' type='checkbox' value='lakme' /></Box></li>
                                <li><Box className='sidebar-checkbox'  onClick={()=>handleFilterMac("lotus")} ><label>Lotus Herbals</label><input  id='pink' name="brand" className='input-checkbox' type='checkbox' value='lba' /></Box></li>
                                <li><Box className='sidebar-checkbox'  onClick={()=>handleFilterMac("nivea")} > <label>Nivea</label><input id='pink' name="brand" className='input-checkbox' type='checkbox' value='milani'/></Box></li>
                            </ul>
                        </details>
                        <hr />
                        <details className="sidebar-dropdown">
                        <summary><Box className='sidebar-title'><Text fontSize='lg' fontWeight='500'>Color</Text> <GrDown/></Box> </summary>
                             <ul>
                                <li><Box className='sidebar-checkbox'  onClick={()=>handleFilterColor("blue")}  ><label>Blue</label><input id='pink' name="color" type='checkbox' /></Box></li>
