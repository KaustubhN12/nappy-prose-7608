  ...
  return (
    <footer>
      <div id="foo_one">
        <div id="foo_email">
          <p>
            <i className="fa fa-envelope"></i> GET SPECIAL DISCOUNT ON YOUR
            INBOX
          </p>
          <form action="">
        ...
        <div id="foo_experience">
          <div id="icon_wrapper">
            <i className="fas fa-mobile-android-alt" id="foot--mobile"></i>
      ...
      <div id="foo_menu">
        <div className="foo_menu_container">
          <ul>
            <li>
              <img src="./nykaa-logo.png" alt="nykaa logo" />
            </li>
            <li>
              <a href="#">WHO ARE WE?</a>
            </li>
        ...
        <div className="foo_menu_container">
          <ul>
            ...
            <li>
              <a
                target="_blank"
                href="https://seller-beautybomb.netlify.app/index.html"
              >
                SELL ON NYKAA
              </a>
            </li>
      ...
      <div id="foo_social">
        <div id="foo_social_prod_icons">
          <div className="product_guideline">
          ...
          <div className="product_guideline">
            ...
            <div className="text_wrapper">
              ...
              <div className="text_content">
                <p>
                  Well Curated 1.9Lakh <br /> + Product
                </p>
              </div>
            </div>
          </div>
        ...
        <div id="foo_social_icons">
          ...
          <div id="foo_social_icons">
            <ul>
              ...
              <li>
                <a href="https://twitter.com/MyNykaa" target="_blank">
                  <img
              ...
              <li>
                <a href="https://www.pinterest.com/mynykaa/" target="_blank">
                  <img
      ...
      <div id="foo_last">
        ...
        <div>
          <p>
            <span>&copy;</span> Nykaa E-Retail Pvt. Ltd.All Rights Reserved
          </p>
        </div>
      </div>
    </footer>
