  ...
  return (
    ...
    >
      ...
      >
        ...
        <Flex direction="column" gap="3">
          ...
          >
            ...
            <Box border="0px solid black" marginTop="5px" marginLeft="25px">
              {" "}
              {method === "Card" ? (
                <CreditCard />
              ) : method === "Cod" ? (
      ...
      >
        <Box>
          <Image
            src="https://adn-static1.nykaa.com/media/wysiwyg/Payments/DesktopRevamp_icons/Illus_3.svg"
            width=""
            height=""
            alt=""
          />
        </Box>
        <Box width={"80%"} border="0px solid red" marginLeft="80px">
